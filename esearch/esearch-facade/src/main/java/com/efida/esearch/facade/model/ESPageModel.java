...
public class ESPageModel<T> implements Serializable {
    /**  */
    ...
    public ESPageModel(List<T> list, long allRow, long currentPage, int pageSize) {
        super();
        this.list = list;
        this.allRow = allRow;
    ...
    public static long countOffset(final long currentPage, final int pageSize) {
        final long offset = (pageSize * (currentPage - 1));
        return offset;
    }
