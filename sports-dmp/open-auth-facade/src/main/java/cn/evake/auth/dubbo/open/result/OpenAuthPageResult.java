package cn.evake.auth.dubbo.open.result;
 ...
 * @author wangyi
 * @desc @param <T>
 * @version $Id: OpenAuthPageResult.java, v 0.1 2017年10月29日 下午6:20:41 wangyi Exp $
 */
public class OpenAuthPageResult<T> implements Serializable {
    /**  */
    ...
    public OpenAuthPageResult() {
        super();
    }

    public OpenAuthPageResult(List<T> list, long allRow, int currentPage, int pageSize) {
        super();
        this.list = list;
        this.allRow = allRow;
