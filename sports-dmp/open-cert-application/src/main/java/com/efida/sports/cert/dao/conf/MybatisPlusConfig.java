package com.efida.sports.cert.dao.conf;
...
@Configuration
@MapperScan("com.efida.sports.cert.dao.mapper")
public class MybatisPlusConfig {
    ...
    public MybatisSqlSessionFactoryBean mybatisSqlSessionFactoryBean() {
        ...
        if (StringUtils.hasText(this.properties.getConfigLocation())) {
            mybatisPlus.setConfigLocation(this.resourceLoader.getResource(this.properties
                .getConfigLocation()));
        }
        ...
        global.setIdType(IdType.ID_WORKER.getKey());
