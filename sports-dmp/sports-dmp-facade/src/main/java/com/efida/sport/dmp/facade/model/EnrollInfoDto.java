 ...
 * 与开放接口保持一致。 
 * @author zhiyang
 * @version $Id: EnrollInfoDto.java, v 0.1 2018年7月5日 下午3:24:00 zhiyang Exp $
 */
public class EnrollInfoDto implements Serializable {
    /**  */
    ...
    /**
     * Getter method for property <tt>eventStartTime</tt>.
     * 
     * @return property value of eventStartTime
     */
    ...
    /**
     * Setter method for property <tt>eventStartTime</tt>.
     * 
     * @param eventStartTime value to be assigned to property eventStartTime
     */
    ...
    /**
     * Getter method for property <tt>eventEndTime</tt>.
     * 
     * @return property value of eventEndTime
     */
    ...
    /**
     * Setter method for property <tt>eventEndTime</tt>.
     * 
     * @param eventEndTime value to be assigned to property eventEndTime
     */
