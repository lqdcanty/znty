package com.efida.sport.dmp.facade.result;
 ...
 * @author wangyi
 * @desc @param <T>
 * @version $Id: SportsAdminPagingResult.java, v 0.1 2017年10月29日 下午6:20:41 wangyi Exp $
 */
public class DmpPageResult<T> implements Serializable {
    /**  */
    ...
    public DmpPageResult() {
        super();
    }

    public DmpPageResult(List<T> list, long allRow, int currentPage, int pageSize) {
        super();
        this.list = list;
        this.allRow = allRow;
