package cn.evake.auth.util.devices;
 ...
 * 设备类型工具类
 * @author Evance
 * @version $Id: DeviceUtils.java, v 0.1 2018年9月2日 下午11:14:16 Evance Exp $
 */
public class DeviceUtils {
    ...
    private static String[] pcHeaders              = new String[] { "Windows 98", "Windows ME",
