...
layui.use(['form','jquery',"layer"],function() {
       ...
       var defaultAvatar="http://img.zcool.cn/community/0177b355ed01bc6ac7251df8f6be5a.png@1280w_1l_2o_100sh.webp";
    ...
    if(window.sessionStorage.getItem('userFace') &&  $(".userAvatar").length > 0){
        ...
        $("#userFace").attr("src",defaultAvatar);
    }
    ...
    function lockPage(){
        layer.open({
            ...
            content : '<div class="admin-header-lock" id="lock-box">'+
                            '<div class="admin-header-lock-img"><img src="'+defaultAvatar+'"class="userAvatar"/></div>'+
    ...
    // 解锁
    console.log($("#userPassword").text(),"密码")
    $("body").on("click","#unlock",function(){
        if($(this).siblings(".admin-header-lock-input").val() == ''){
        	...
        	$.ajax({
        		url:'/api/user/me/pass/check',
        		type:'get',
        		data:{pass:$(this).siblings(".admin-header-lock-input").val()},
        		success:function(data){
        	        if(data.code==0){
        	        	if(data.data){
        	        		...
        	        		layer.msg('密码错误');
        	        		//$("。input_btn").children(".admin-header-lock-input").focus();
        	        	}
        	        }else{
