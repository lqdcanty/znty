...
layui.use(['bodyTab','form','element','layer','jquery'],function(){
	var form = layui.form,
		...
		tab = layui.bodyTab({
			...
			url : realPath+"/api/user/menu?timestamp=" + (new Date()).valueOf() //获取菜单json地址
		});
	...
	function changePassword() {
		...
		var passObj = {};
		passObj.oldPass  = $("#oldPassword").val();
		passObj.newPass = $("#password").val();
		$.ajax({
			type: 'Get',
			url: "/api/user/me/update/pass",
			cache: false,
			data: passObj,
