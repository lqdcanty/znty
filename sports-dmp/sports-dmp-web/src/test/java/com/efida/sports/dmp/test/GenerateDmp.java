...
public class GenerateDmp {

    @Test
    public void generateCode() {
        String packageName = "cn.evake.app.dao";
    ...
    private void generateByTables(boolean serviceNameStartWithI, String packageName,
                                  String... tableNames) {
        String dbUrl = "jdbc:mysql://122.115.40.84:23306/sports-dmp?useUnicode=true&characterEncoding=utf8&useSSL=false";
        ...
        dataSourceConfig.setUsername("deploy_admin");
        dataSourceConfig.setPassword("WECBrsggz175sR1");
