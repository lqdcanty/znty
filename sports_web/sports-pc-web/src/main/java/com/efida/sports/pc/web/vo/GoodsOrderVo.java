...
public class GoodsOrderVo {
    ...
    public static GoodsOrderVo getVo(GoodsOrder order) {
        ...
        vo.setOrderPriceStr(AmountUtils.changeF2Y(order.getOrderPrice() + ""));
        vo.setOrderStatusDesc(OrderStatusEnum.getDescByCode(order.getOrderStatus()));
        vo.setPayWayCode(order.getPayWayCode());
