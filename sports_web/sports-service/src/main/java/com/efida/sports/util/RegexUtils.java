 ...
 * @author wang yi
 * @desc 
 * @version $Id: RegexUtils.java, v 0.1 2018年6月27日 下午4:06:53 wang yi Exp $
 */
public class RegexUtils {
    ...
    */
    ...
    public static boolean checkPassport(String passPort) {
        return StringUtils.isNotEmpty(passPort);
     ...
     * 正则表达式：验证军官证
     */
    public static boolean checkCertificateOfficers(String num) {
        return StringUtils.isNotEmpty(num);

        //        String regex = " /[\\u4e00-\\u9fa5](字第){1}(\\d{4,8})(号?)$/";
     ...
     * @return 验证成功返回true，验证失败返回false
     */
    public static boolean checkAssettoId(String assettoId) {
        String regex = "[0-9A-Za-z]*";
        return Pattern.matches(regex, assettoId);
    }
