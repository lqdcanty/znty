 ...
 * 
 * @author zoutao
 * @version $Id: VerifyCodeUtil.java, v 0.1 2018年1月23日 下午3:29:06 zoutao Exp $
 */
public class VerifyCodeUtil {
    ...
    //生成短信验证码
    public static String getSMSVerifyCode(int length) {
        StringBuffer randomBuffer = new StringBuffer();
        for (int i = 0; i < length; i++) {
            int itmp = 0;
            itmp = random.nextInt(10) + 48; // 生成0~9的数字
            char ctmp = (char) itmp;
            randomBuffer.append(ctmp);
        }
    ...
    public static void outputImage(int w, int h, OutputStream os, String code) throws IOException {
        ...
        g2.setColor(new Color(245, 245, 245));// 设置边框色
        g2.fillRect(0, 0, w, h);

        g2.setColor(new Color(245, 245, 245));// 设置背景色
